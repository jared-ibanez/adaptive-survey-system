...
<head>
    ...
    <title>Learning Skills - Adaptive Competency Survey</title>
...
<body class="min-h-screen bg-slate-950 text-white">
    ...
    <header class="sticky top-0 z-50 border-b border-white/10 bg-slate-950/70 backdrop-blur">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 py-3">
            <div class="flex items-center justify-between gap-4">
                ...
                <a href="{{ route('survey.dimension2') }}"
    ...
    <main class="relative mx-auto max-w-5xl px-4 sm:px-6 py-8">
        ...
        <details class="rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-5 backdrop-blur" open="false">
            <summary class="cursor-pointer list-none select-none">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-2 text-[11px] text-white/60">
                        <span class="rounded-full border border-white/10 bg-slate-900/30 px-3 py-1">Items 11–15</span>
                        <span class="rounded-full border border-white/10 bg-slate-900/30 px-3 py-1">Learning Skills</span>
            ...
            <div class="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
                ...
                <div class="rounded-2xl border border-white/10 bg-slate-900/30 px-4 py-3">
                    ...
                    <p class="mt-1 text-sm font-semibold text-white/85 leading-relaxed">3</p>
                </div>
        ...
        <!-- Dimension title -->
        <section class="mt-8">
            <p class="text-xs uppercase tracking-wider text-white/50">Dimension 3</p>
            <h2 class="mt-1 text-2xl font-extrabold tracking-tight sm:text-3xl">Learning Skills</h2>
            <p class="mt-2 text-sm text-white/65">Choose the option that best describes what you would do.</p>
        </section>

        <form method="POST" action="{{ route('survey.dimension3.save') }}" id="dimension3Form" class="mt-6 space-y-5">
            @csrf
        ...
        @php
            ...
            $questions = [
                11 => "When assigned a research task in class, I…",
                12 => "If I do not understand a lesson, I…",
                13 => "When memorizing concepts, I…",
                14 => "When a topic feels difficult, I…",
                15 => "When improving my study habits, I…",
            ];

            $choices = [
                11 => [
                    ['score' => 0, 'text' => 'copy information without checking if it answers the question.'],
                    ['score' => 3, 'text' => 'compare information from different sources and explain it in my own words.'],
                    ['score' => 1, 'text' => 'use only one source without checking if it is reliable.'],
                    ['score' => 2, 'text' => 'use two or more appropriate sources like books or teacher-provided materials.'],
                ],
                12 => [
                    ['score' => 0, 'text' => 'do nothing.'],
                    ['score' => 3, 'text' => 'seek clarification and use additional learning strategies.'],
                    ['score' => 2, 'text' => 'review materials and ask questions.'],
                    ['score' => 1, 'text' => 'wait for someone to explain later.'],
                ],
                13 => [
                    ['score' => 0, 'text' => 'cram at the last minute.'],
                    ['score' => 2, 'text' => 'use structured strategies like summarizing, practice, and recall.'],
                    ['score' => 1, 'text' => 'reread repeatedly.'],
                    ['score' => 3, 'text' => 'use spaced practice and self-testing consistently.'],
                ],
                14 => [
                    ['score' => 2, 'text' => 'break the task into smaller parts.'],
                    ['score' => 1, 'text' => 'try briefly but stop when confused.'],
                    ['score' => 0, 'text' => 'give up quickly.'],
                    ['score' => 3, 'text' => 'break it down, seek help when needed, and monitor my understanding.'],
                ],
                15 => [
                    ['score' => 0, 'text' => 'make no changes.'],
                    ['score' => 2, 'text' => 'identify weaknesses and set improvement goals.'],
                    ['score' => 1, 'text' => 'try random new strategies.'],
                    ['score' => 3, 'text' => 'set goals, apply strategies, and evaluate progress regularly.'],
                ],
            ];
        @endphp
            ...
            <!-- ✅ Standard button container spacing (your project standard) -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // AJAX save on Next
            const form = document.getElementById('dimension3Form');
