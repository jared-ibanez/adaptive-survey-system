...
<head>
    ...
    <title>Flexible Thinking - Adaptive Competency Survey</title>
...
<body class="min-h-screen bg-slate-950 text-white">
    ...
    <header class="sticky top-0 z-50 border-b border-white/10 bg-slate-950/70 backdrop-blur">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 py-3">
            <div class="flex items-center justify-between gap-4">
                ...
                <a href="{{ route('survey.dimension4') }}"
    ...
    <main class="relative mx-auto max-w-5xl px-4 sm:px-6 py-8">
        ...
        <details class="rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-5 backdrop-blur">
            <summary class="cursor-pointer list-none select-none">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-2 text-[11px] text-white/60">
                        <span class="rounded-full border border-white/10 bg-slate-900/30 px-3 py-1">Items 21–25</span>
                        <span class="rounded-full border border-white/10 bg-slate-900/30 px-3 py-1">Flexible Thinking</span>
            ...
            <div class="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
                ...
                <div class="rounded-2xl border border-white/10 bg-slate-900/30 px-4 py-3">
                    ...
                    <p class="mt-1 text-sm font-semibold text-white/85 leading-relaxed">5</p>
                </div>
        ...
        <!-- Dimension title -->
        <section class="mt-8">
            <p class="text-xs uppercase tracking-wider text-white/50">Dimension 5</p>
            <h2 class="mt-1 text-2xl font-extrabold tracking-tight sm:text-3xl">Flexible Thinking</h2>
            <p class="mt-2 text-sm text-white/65">Choose the option that best describes what you would do.</p>
        </section>

        <form method="POST" action="{{ route('survey.dimension5.save') }}" id="dimension5Form" class="mt-6 space-y-5">
            @csrf
        ...
        @php
            ...
            $questions = [
                21 => "When instructions change suddenly, I…",
                22 => "When plans change location, I…",
                23 => "When placed in a new group, I…",
                24 => "If a disruption affects my study time, I…",
                25 => "When asked to try a new method, I…",
            ];

            $choices = [
                21 => [
                    ['score' => 1, 'text' => 'follow but complain repeatedly.'],
                    ['score' => 3, 'text' => 'adjust quickly and help others understand the change.'],
                    ['score' => 0, 'text' => 'refuse to follow.'],
                    ['score' => 2, 'text' => 'adjust and follow the new instructions.'],
                ],
                22 => [
                    ['score' => 0, 'text' => 'refuse to attend.'],
                    ['score' => 3, 'text' => 'adapt positively and help reorganize if needed.'],
                    ['score' => 1, 'text' => 'attend but remain negative.'],
                    ['score' => 2, 'text' => 'adapt and continue.'],
                ],
                23 => [
                    ['score' => 2, 'text' => 'cooperate and communicate.'],
                    ['score' => 0, 'text' => 'refuse to cooperate.'],
                    ['score' => 3, 'text' => 'engage actively and build collaboration.'],
                    ['score' => 1, 'text' => 'participate minimally.'],
                ],
                24 => [
                    ['score' => 0, 'text' => 'stop working entirely.'],
                    ['score' => 2, 'text' => 'switch to another productive task.'],
                    ['score' => 3, 'text' => 'adjust plans and maximize available time.'],
                    ['score' => 1, 'text' => 'pause and delay continuing.'],
                ],
                25 => [
                    ['score' => 1, 'text' => 'try it reluctantly.'],
                    ['score' => 3, 'text' => 'evaluate the new method and integrate it if effective.'],
                    ['score' => 2, 'text' => 'try it openly.'],
                    ['score' => 0, 'text' => 'refuse to try it.'],
                ],
            ];
        @endphp
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // AJAX save on Next
            const form = document.getElementById('dimension5Form');
